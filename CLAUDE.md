...
- 09:30 — AnkaPhaseCMRKarpathyOpen: H-2026-05-01-phase-c-mr-karpathy-v1 OPEN — POSSIBLE_OPPORTUNITY mean-revert routing, {RISK-ON, CAUTION} regime gate, event-day skip, 6-of-8 Karpathy qualifier. Holdout 2026-05-04 → 2026-08-01 (info)
...
- 14:30 — AnkaPhaseCMRKarpathyClose: H-2026-05-01-phase-c-mr-karpathy-v1 mechanical TIME_STOP close at Kite LTP. Holdout 2026-05-04 → 2026-08-01 (info)
...
**H-2026-05-01-phase-c-mr-karpathy-v1 (regime-aware mean-revert intraday):** PRE_REGISTERED 2026-05-01 to replace the kill-confirmed Phase C v1 LAG live shadow (which produced 0 trades on 5y × 100-ticker minute-resolution replay). Inverts routing to **POSSIBLE_OPPORTUNITY** (|z|≥4 mean-revert), gates regime to **{RISK-ON, CAUTION}** at the V3-CURATED-30 daily label, skips ±1 day around RBI / FOMC / Lok Sabha results / Union Budget / GST council, and applies a **6-of-8 Karpathy random-search Lasso qualifier** on a frozen 8-feature library (cross-sectional dispersion, realized/implied vol gap, breadth-above-20DMA, event-day flag, sector RS z, cross-sector correlation collapse, VWAP-deviation z, news density z). Frozen universe: top 100 F&O by 60-day ADV (HDFCBANK to UPL) intersected with the 5y 5-min cache. ATR(14)×2 per-leg stop, ₹50,000/leg notional, mechanical 14:30 IST close. **Single-touch holdout 2026-05-04 → 2026-08-01** (auto-extend 2026-10-31 if n<100). Pass: §3.1 (mean ≥+30 bps, hit ≥55%, Sharpe ≥1.0) + §9A (Sharpe ≥0.5 in 2 of 3 monthly buckets) + §9B.1 (≥10 bps margin vs regime-gated-no-Karpathy baseline). Stretch: Sharpe ≥1.5 (SIGNAL), Sharpe ≥2.0 (FLAGSHIP — Bharat's stretch target). Karpathy 28×4×4=448-cell grid search runs ONCE at registration on 2021-05 → 2024-04 training window with BH-FDR. Spec: `docs/superpowers/specs/2026-05-01-phase-c-mr-karpathy-v1-design.md`. Engine: `pipeline/research/h_2026_05_01_phase_c_mr_karpathy/`. Ledger: `pipeline/data/research/h_2026_05_01_phase_c_mr_karpathy/recommendations.csv`. **No parameter changes during the holdout window per backtesting-specs.txt §10.4 strict.**
