...
prompt = (
    ...
    "2. **Header**: Company name HAL, date April 2026, Pattern Premium score as a colored badge, one-line verdict\n"
    ...
    "15. **Pattern Premium Verdict**: Score +2.8%, components breakdown in a visual box. BUT with the caveat that valuation forensics suggest the market is ahead of execution.\n"
